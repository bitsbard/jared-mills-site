    ...
    <div className="min-h-screen text-white overflow-x-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full bg-black">
        <div className="w-full h-full md:block relative">
          {/* Mobile background (positioned near top) */}
          <div className="md:hidden w-full absolute top-[10%]">
            <Image
        ...
        <section id="skills" className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <SkillCard 
              icon={<Server />} 
              title="Backend" 
              skills={["Node.js", "Express", "Python", "Java", "ELT/ETL Pipelines", "Data Modeling", "Computer Vision", "NLP", "Supervised Learning", "Reinforcement Learning"]} 
            />
            <SkillCard 
              icon={<Database />} 
              title="Databases" 
