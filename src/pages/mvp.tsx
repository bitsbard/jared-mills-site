    ...
    <div className="min-h-screen text-white overflow-x-hidden">
      ...
      <main className="relative z-10 mt-16">
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="bg-gray-800 bg-opacity-50 p-8 rounded-lg mb-8">
            ...
            <p className="text-lg mb-8 text-center">Ready to turn your idea into reality?</p>
