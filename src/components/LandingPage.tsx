...
const LandingPage = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (contentRef.current) {
        ...
        contentRef.current.style.top = `${Math.max(0, scrollTop)}px`;
      }
    };
  ...
  return (
    <div className="min-h-screen text-white relative">
      ...
      <div ref={contentRef} className="relative z-10">
        ...
        <main>
          <section className="max-w-4xl mx-auto px-4 py-16 text-left">
            ...
            <div className="grid grid-cols-1 gap-8 mb-16 bg-black p-8 rounded-lg">
              <ProjectCard
                title="Project Alpha"
      ...
      <footer className="bg-black py-12 relative z-20">
